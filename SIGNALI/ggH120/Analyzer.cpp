...
//_lumi postavljam sam na neku vrijednost
 ...
 /*if (fChain == 0) return;
   ...
   RooFormulaVar wFunc("gen","(137.0 * 1000 * 0.0086633  * y ) / 32218946.0 * z",RooArgSet( y,z)) ;
...
suma= suma + (137.0 * 1000 * 0.0086633 * overallEventWeight  ) / 32218946.0 * ggH_NNLOPS_weight;
counter++;}
	}	
   }
