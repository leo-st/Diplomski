...
//_lumi postavljam sam na neku vrijednost
 ...
 /*if (fChain == 0) return;
   ...
   RooFormulaVar wFunc("gen","(137.0 * 1000 * 0.014371  * y ) / 25305060.0 * z",RooArgSet( y,z)) ;
...
suma= suma + (137.0 * 1000 * 0.014371 * overallEventWeight  ) / 25305060.0 * ggH_NNLOPS_weight;
counter++;}
	}	
   }
